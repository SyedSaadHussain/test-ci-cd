...
//  int? numberWomenRows;
  ...
  List<Map<String, dynamic>>? propertyTypeIds;
  ...
  bool? isInsideHaramMakkah;
  bool? isInPilgrimHousingMakkah;
  bool? isInsideHaramMadinah;
  bool? isInVisitorHousingMadinah;
  ...
  bool get isEditMosqueMode => (state=='edit');

  bool get isActionButton => (this.displayButtonAccept??false) || (this.displayButtonRefuse??false);

  bool get isReasonReturn => AppUtils.isNotNullOrEmpty(this.observationText) || AppUtils.isNotNullOrEmpty(this.refuseReason);
  ...
  Mosque.shallowCopy(Mosque other)
      : id = other.id,
        name = other.name,
        refuseReason = other.refuseReason,
        ...
        relateEmployeeIds = other.relateEmployeeIds,
        ...
        womenPrayerRoomCapacity = other.womenPrayerRoomCapacity,
        ...
        waterMeterIds = other.waterMeterIds,
        ...
        hasExternalCamera = other.hasExternalCamera,
        ...
        isThereLandTitle = other.isThereLandTitle,
        ...
        isInsideHaramMakkah = other.isInsideHaramMakkah,
        isInPilgrimHousingMakkah = other.isInPilgrimHousingMakkah,
        isInsideHaramMadinah = other.isInsideHaramMadinah,
        isInVisitorHousingMadinah = other.isInVisitorHousingMadinah,
        displayButtonSend = other.displayButtonSend,
        displayButtonSetToDraft = other.displayButtonSetToDraft,
...
//    this.numberWomenRows,
  ...
  factory Mosque.fromJson(Map<String, dynamic> json) {
    ...
    return Mosque(
      ...
      observationText: JsonUtils.toText(json['observation_text']),
      refuseReason: JsonUtils.toText(json['refuse_reason']),
      ...
      mosqueType: (((json['mosque_type_id']??false)==false?[]:json['mosque_type_id']) as List<dynamic>).getName(),
      mosqueTypeId: (((json['mosque_type_id']??false)==false?[]:json['mosque_type_id']) as List<dynamic>).getId(),
      ...
      relateEmployeeIds:JsonUtils.toList(json['relate_employee_ids']),
      ...
      noPlanned: JsonUtils.toText(json['no_planned']),
       pieceNumber: JsonUtils.toText(json['piece_number']),
      ...
      //numberWomenRows: JsonUtils.toInt(json['number_women_rows']),
        womenPrayerRoomCapacity: JsonUtils.toInt('women_prayer_room_capacity'),
      ...
      waterMeterIds: JsonUtils.toList(json['water_meter_ids']),
      meterIds: JsonUtils.toList(json['meter_ids']),
      ...
      hasExternalCamera: JsonUtils.toText(json['has_external_camera']),
      ...
      acType: JsonUtils.toList(json['ac_type']),
      ...
      isThereLandTitle: JsonUtils.toText(json['is_there_land_title']),
      ...
      propertyTypeIds: json['property_type_ids'] is List
          ? (json['property_type_ids'] as List)
      ...
      //new fields addition 20oct2025
      isInsideHaramMakkah: JsonUtils.toBoolean(json['is_inside_haram_makkah']),
      isInPilgrimHousingMakkah: JsonUtils.toBoolean(json['is_in_pilgrim_housing_makkah']),
      isInsideHaramMadinah: JsonUtils.toBoolean(json['is_inside_haram_madinah']),
      isInVisitorHousingMadinah: JsonUtils.toBoolean(json['is_in_visitor_housing_madinah']),
