...
class VisitRepository {
  ...
  VisitRepository(client,{UserProfile? userProfile}){
    this.client = client;
    if(userProfile!=null)
    ...
    try {
      dynamic _payload={
        ...
        'kwargs': {
          ...
          'domain': domain,
          'fields': ["name", "mosque_seq_no", "date_of_visit", "priority","priority_value","observer",'__last_update','state','stage_id'],
  ...
  Future<dynamic> onChange({String? field}) async {
    try {
  ...
  Future<dynamic> getVisitDetail(int id) async {
    try {
      ...
      dynamic _payload={
        "args": [
          ...
          [
            ...
            "imam_on_leave_from",
            "imam_on_leave_to",
            "moazen_on_leave_from",
            "moazen_on_leave_to",
            "moazen_off_work_date",
            "imam_off_prayers",
            "imam_off_prayers_id",
            "imam_notes",
            "muazzin_emp_id",
      ...
      //print(response["imam_off_work_date"]);
  ...
  Future<dynamic> getVisitFilter(String field,{dynamic domain}) async {
    try {
