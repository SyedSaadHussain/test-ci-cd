...
class RegionList extends StatefulWidget {
  ...
  RegionList({required this.client,required this.onItemTap,required this.countryId});
  @override
...
class _RegionListState extends State<RegionList> {
  ...
  void searchRecords(bool isReload){
    ...
    _userService!.getRegions(10,regionData.pageIndex,_controller.text,this.widget.countryId).then((value){
