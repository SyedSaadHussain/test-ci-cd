...
class _DistrictListState extends State<DistrictList> {
  ...
  void searchRecords(bool isReload){
    ...
    _userService!.getDistracts(10,data.pageIndex,_controller.text).then((value){
