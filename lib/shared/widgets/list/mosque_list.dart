...
class MosqueList extends StatefulWidget {
  ...
  final String? title;
  MosqueList({required this.client,required this.onItemTap,this.title,required this.userProfile});
  @override
...
class _MosqueListState extends State<MosqueList> {
  ...
  void initState() {
    ...
    _userService = UserService(this.widget.client!,userProfile: this.widget.userProfile);
    _mosqueService = MosqueService(this.widget.client!,userProfile: this.widget.userProfile);
    super.initState();
  }
