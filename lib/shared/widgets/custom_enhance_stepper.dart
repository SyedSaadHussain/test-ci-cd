...
@immutable
class CustomEnhanceStep {
  /// Creates a step for a [Stepper].
  ///
  /// The [title], [content], and [state] arguments must not be null.
  const CustomEnhanceStep({
    this.icon,
    required this.title,
    this.subtitle,
...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class CustomEnhanceStepper extends StatefulWidget {
  ...
  const CustomEnhanceStepper({
    Key? key,
    required this.steps,
    this.physics,
    this.stepIconSize = _kStepSize,
    this.type = StepperType.vertical,
    this.horizontalTitlePosition = HorizontalTitlePosition.bottom,
  ...
  final List<CustomEnhanceStep> steps;
  ...
  @override
  State<CustomEnhanceStepper> createState() => _EnhanceStepperState();
}

class _EnhanceStepperState extends State<CustomEnhanceStepper>
  ...
  @override
  void didUpdateWidget(CustomEnhanceStepper oldWidget) {
  ...
  Widget _buildCircle(int index, bool oldState) {
    CustomEnhanceStep step = widget.steps[index];
