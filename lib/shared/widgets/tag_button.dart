...
class AppNewTagButton extends StatefulWidget {
  ...
  final Function? onChange;
  final Color color;
  AppNewTagButton({Key? key,this.activeButtonIndex=0,this.index,required this.title,
    this.onChange,this.color=AppColors.tertiary
  }): super(key: key);
  @override
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          shape: BoxShape.rectangle,
          borderRadius: BorderRadius.circular(15), // Adjust the radius as needed
          color: this.widget.activeButtonIndex == this.widget.index ? this.widget.color : AppColors.backgroundColor,
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              this.widget.title,
              style: TextStyle(
                color: this.widget.activeButtonIndex == this.widget.index
