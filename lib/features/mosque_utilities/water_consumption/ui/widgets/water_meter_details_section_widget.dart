...
class WaterMeterDetailsSectionWidget extends StatelessWidget {
  final int meterId;
  final String? meterNumber;
  const WaterMeterDetailsSectionWidget({super.key, required this.meterId, this.meterNumber});

  @override
  Widget build(BuildContext context) {
    return Consumer<WaterInvoiceViewModel>(
