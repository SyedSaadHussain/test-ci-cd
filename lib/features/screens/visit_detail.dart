...
class VisitDetail extends StatefulWidget {
  ...
  VisitDetail({required this.visitIdId,this.onCallback});
  @override
  _VisitDetailState createState() => _VisitDetailState();
}

class _VisitDetailState extends BaseState<VisitDetail> with TickerProviderStateMixin   {
  ...
  void calculateGpsLocation(){
    coordinates=  appUserProvider!.coordinates;
    _visitDetail.totalLocation=coordinates.length;
    _visitDetail.lastLocation=coordinates.toString();
    _visitDetail.matchingLocation = permission.getTotalMatch(coordinates);
  }
  dynamic _headersMap;
  @override
  ...
  void onChangeMoazenOffWork(){
    if(_visitDetail.moazenPresent=='notpresent')
      _visitDetail.moazenOffPrayersId=_visitDetail.prayerName;
    else{
      _visitDetail.moazenOffPrayersId=null;
      _visitDetail.moazenOffWorkDate=null;
    }
    ...
    // _visitService!.onChangeMoazenOffWork(_visitDetail).then((value){
    //
    //     _visitDetail=value;
    //     setState(() {
    //
  ...
  void onChangeImamOffWork(){

    if(_visitDetail.imamPresent=='notpresent')
      _visitDetail.imamOffPrayersId=_visitDetail.prayerName;
    else{
      _visitDetail.imamOffPrayersId=null;
      _visitDetail.imamOffWorkDate=null;
    }
    print('_visitDetail.imamPresent');
    print(_visitDetail.imamPresent);
    print(_visitDetail.imamOffPrayersId);
    setState(() {

    });

    //print(_visitDetail.imamOffWork);
    // _visitService!.onChangeImamOffWork(_visitDetail).then((value){
    //
    //     _visitDetail=value;
    //     setState(() {
    //
  ...
  void renderTabs(){
    ...
    if(_visit!.isFriday??false)
     _tabs.add(TabForm(title: 'khateeb'.tr(),isShowEdit:true));
  ...
  void getAllEmployees(){
    ...
    if(employeeIds.length>0){
      _userService!.getEmpPublicByIds(employeeIds).then((employees){
  ...
  void startEdit(){
    ...
    permission=new GPSPermission(
      allowDistance: 100,
      latitude:(_visit!.latitude??0),
      longitude:(_visit!.longitude??0),
    );
    setState((){
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
            ...
            children: [
              Column(
                ...
                children: [
                      ...
                      children: [
                        ...
                        Row(
                            ...
                            children:[
                              ...
                              //   // ),
                              // ),
                              ImageData(id: _visit.id??0, modelName: Model.visit, fieldId: "outer_image",uniqueId: _visit.uniqueId,baseUrl: appUserProvider.baseUrl,headersMap: _headersMap,height: 90,width: 80,),
                                      ...
                                      body:  Form(
                                        ...
                                        child: TabBarView(
                                          ...
                                          children: [
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          EmployeeListTitle(Employee(id:_visit.observerId,name:_visit.observer  ),null,appUserProvider.baseUrl),
                                                          ),
                                            ...
                                            if (_visit!.isFriday??false) (isEditMode && _visit.khateebId!=null)?Column(
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                    ...
                                                    child: SingleChildScrollView(
                                                      child: Column(
                                                        children: [
                                                          AppListTitle2(title: getField('khateeb_id')!.label,hasDivider:false,child:
                                                          _visit.khateebId==null?Container():EmployeeListTitle(Employee(id:_visit.khateebId,name:_visit.khateeb  ),null,appUserProvider.baseUrl),
                                                          ),
                                                          CustomFormField(title: getField('khateeb_present')!.label,
                                                            value: _visitDetail.khateebPresent,onChanged:(val){
                                                              _visitDetail.khateebPresent = val;
                                                              setState((){});
                                                            }
                                                            ,type: FieldType.choice,
                                                            options:getComboList('khateeb_present').toList().where((item) => item.key != 'notapplicable')
                                                                .toList(),
                                                          ),

                                                          CustomFormField(title: getField('khateeb_absent_gomaa')!.label,
                                                            value: _visitDetail.khateebAbsentGomaa,onChanged:(val){
                                                              _visitDetail.khateebAbsentGomaa = val;
                                                              setState((){});
                                                            }
                                                            ,type: FieldType.choice,
                                                            options:getComboList('khateeb_absent_gomaa')
                                                                .toList(),
                                                          ),

                                                          CustomFormField(title: getField('khateeb_notes')!.label,
                                                            value: _visitDetail.khateebNotes,onChanged:(val){
                                                              _visitDetail.khateebNotes = val;
                                                              setState((){});
                                                            }
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          AppListTitle2(title:getField('khateeb_present')!.label,subTitle: _visit.khateebPresent??"",
                                                              selection:getComboList('khateeb_present'),isTag:true),


                                                         
                                                          _visit.khateebPresent!='notapplicable'?Column(
                                                            children: [
                                                              AppListTitle2(title:getField('khateeb_absent_gomaa')!.label,subTitle: _visit.khateebAbsentGomaa??"",
                                                                  selection:getComboList('khateeb_absent_gomaa'),isTag:true),
                                                              AppListTitle2(title: getField('khateeb_notes')!.label,subTitle: _visit.khateebNotes??""),
                                                            ],
                                                          ):Container(),
                                            ...
                                            (isEditMode && _visit.imamEmpId!=null)?Column(
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                    padding: EdgeInsets.symmetric(horizontal: 10,vertical: 5),
                                                    child: SingleChildScrollView(
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          _visit.imamEmpId==null?Container():EmployeeListTitle(Employee(id:_visit.imamEmpId,name:_visit.imamEmp  ),null,appUserProvider.baseUrl),
                                                          ),
                                                          CustomFormField(title: getField('imam_present')!.label,
                                                            value: _visitDetail.imamPresent,onChanged:(val){
                                                              ...
                                                              print(_visitDetail.imamPresent);
                                                              if(_visitDetail.imamPresent!='notpresent'){
                                                                _visitDetail.imamOffWork=null;
                                                              }
                                                              if(_visitDetail.imamPresent!='leave'){
                                                                _visitDetail.imamOnLeaveFrom=null;
                                                                _visitDetail.imamOnLeaveTo=null;
                                                              }
                                                              onChangeImamOffWork();
                                                              setState((){});
                                                            }
                                                            ,type: FieldType.choice,
                                                            options:getComboList('imam_present').toList().where((item) => item.key != 'notapplicable')
                                                                .toList(),
                                                          ),

                                                          _visitDetail.imamPresent=='notpresent'?Column(
                                                            children: [
                                                              ...
                                                              _visitDetail.imamOffWork=='yes'?Column(
                                                                children: [
                                                                  CustomFormField(title:  fields.getField('imam_off_work_date').label,value: _visitDetail.imamOffWorkDate,

                                                                      onChanged:(val){
                                                                        _visitDetail.imamOffWorkDate = val;
                                                              ...
                                                              AppListTitle2(title: getField('imam_off_prayers_id')!.label,subTitle: _visitDetail.imamOffPrayersId??"",
                                                                  selection:fields.getComboList('imam_off_prayers_id')),

                                                            ],
                                                          ):Container(),

                                                          _visitDetail.imamPresent=='leave'?Column(
                                                            children: [
                                                              CustomFormField(title: getField('imam_on_leave_from')!.label,
                                                                value: _visitDetail.imamOnLeaveFrom,onChanged:(val){
                                                                  _visitDetail.imamOnLeaveFrom = val;
                                                                  setState((){});
                                                                }
                                                                ,type:FieldType.date,

                                                              ),
                                                              CustomFormField(title: getField('imam_on_leave_to')!.label,
                                                                value: _visitDetail.imamOnLeaveTo,onChanged:(val){
                                                                  _visitDetail.imamOnLeaveTo = val;
                                                                  setState((){});
                                                                }
                                                                ,type:FieldType.date,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          _visit.imamPresent=='notpresent'?Column(
                                                            children: [
                                                              ...
                                                              _visit.imamOffWork=='yes'?Column(
                                                                children: [
                                                                  AppListTitle2(title: getField('imam_off_work_date')!.label,subTitle: _visit.imamOffWorkDate??"",isDate: true),
                                                          ...
                                                          _visit.imamPresent=='leave'?Column(
                                                            children: [
                                                              AppListTitle2(title: getField('imam_on_leave_from')!.label,subTitle: _visit.imamOnLeaveFrom??"",isDate: true),
                                                              AppListTitle2(title: getField('imam_on_leave_to')!.label,subTitle: _visit.imamOnLeaveTo??"",isDate: true)
                                                            ],
                                                          ):Container(),

                                                          _visit.imamPresent!='notapplicable'?AppListTitle2(title: getField('imam_notes')!.label,subTitle: _visit.imamNotes??""):Container(),
                                            ...
                                            (isEditMode && _visit.muazzinEmpId!=null)?Column(
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                    padding: EdgeInsets.symmetric(horizontal: 10,vertical: 5),
                                                    child: SingleChildScrollView(
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          _visit.muazzinEmpId==null?Container():EmployeeListTitle(Employee(id:_visit.muazzinEmpId,name:_visit.muazzinEmp  ),null,appUserProvider.baseUrl),
                                                          ),
                                                          CustomFormField(title: getField('moazen_present')!.label,
                                                            value: _visitDetail.moazenPresent,onChanged:(val){
                                                              ...
                                                              setState((){});
                                                              print(_visitDetail.moazenPresent);
                                                              if(_visitDetail.moazenPresent!='notpresent'){
                                                                //_visitDetail.moazenExist=null;
                                                                _visitDetail.moazenOffWork=null;
                                                                _visitDetail.moazenOffWorkDate=null;

                                                              }
                                                              if(_visitDetail.moazenPresent!='leave'){
                                                                _visitDetail.moazenOnLeaveTo=null;
                                                                _visitDetail.moazenOnLeaveFrom=null;
                                                              }
                                                              onChangeMoazenOffWork();
                                                              setState((){});
                                                            ...
                                                            ,type: FieldType.choice,
                                                            options:getComboList('moazen_present').toList().where((item) => item.key != 'notapplicable')
                                                                .toList(),
                                                          ),

                                                          _visitDetail.moazenPresent=='notpresent'?Column(
                                                            children: [
                                                              ...
                                                              CustomFormField(title: getField('moazen_off_work')!.label,
                                                                value: _visitDetail.moazenOffWork,onChanged:(val){
                                                                  ...
                                                                  if(_visitDetail.moazenOffWork!='yes'){
                                                                    _visitDetail.moazenOffWorkDate=null;
                                                                  }
                                                                  setState((){});
                                                              ...
                                                              _visitDetail.moazenOffWork=='yes'?Column(
                                                                children: [
                                                                  CustomFormField(title:  fields.getField('moazen_off_work_date').label,value: _visitDetail.moazenOffWorkDate,

                                                                      onChanged:(val){
                                                                        _visitDetail.moazenOffWorkDate = val;
                                                              ...
                                                              AppListTitle2(title: getField('moazen_off_prayers_id')!.label,subTitle: _visitDetail.moazenOffPrayersId??"",
                                                          ...
                                                          _visitDetail.moazenPresent=='leave'?Column(
                                                            children: [
                                                              CustomFormField(title: getField('moazen_on_leave_from')!.label,
                                                                value: _visitDetail.moazenOnLeaveFrom,onChanged:(val){
                                                                  _visitDetail.moazenOnLeaveFrom = val;
                                                                  setState((){});
                                                                }
                                                                ,type:FieldType.date,

                                                              ),
                                                              CustomFormField(title: getField('moazen_on_leave_to')!.label,
                                                                value: _visitDetail.moazenOnLeaveTo,onChanged:(val){
                                                                  _visitDetail.moazenOnLeaveTo = val;
                                                                  setState((){});
                                                                }
                                                                ,type:FieldType.date,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          // ),
                                                          _visit.moazenPresent=='notpresent'?Column(
                                                            children: [
                                                              ...
                                                              _visit.moazenOffWork=='yes'?Column(
                                                                children: [
                                                                  AppListTitle2(title: getField('moazen_off_work_date')!.label,subTitle: _visit.moazenOffWorkDate??"",isDate: true),
                                                          ...
                                                          _visit.moazenPresent=='leave'?Column(
                                                            children: [
                                                              AppListTitle2(title: getField('moazen_on_leave_from')!.label,subTitle: _visit.moazenOnLeaveFrom??"",isDate: true),
                                                              AppListTitle2(title: getField('moazen_on_leave_to')!.label,subTitle: _visit.moazenOnLeaveTo??"",isDate: true)
                                                            ],
                                                          ):Container(),

                                                          _visit.moazenPresent!='notapplicable'?AppListTitle2(title: getField('moazen_notes')!.label,subTitle: _visit.moazenNotes??''):Container(),
                                            ...
                                            (isEditMode && _servants.length>0)?Column(
                                                ...
                                                Expanded(
                                                  child: Container(
                                                    ...
                                                    child: SingleChildScrollView(
                                                      child: Column(
                                                        children: [
                                                          CustomListField(title: fields.getField('khadem_ids').label,employees: _servants),
                                                          ...
                                                          CustomFormField(title: getField('worker_present')!.label,
                                                            ...
                                                            ,type: FieldType.choice,
                                                            options:getComboList('worker_present').toList().where((item) => item.key != 'notapplicable').toList(),
                                                          ),
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          _visit.workerPresent!='notapplicable'?Column(
                                                            children: [
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          CustomFormField(title: getField('wc_maintenance_notes')!.label,
                                                          ...
                                                          Column(
                                                            children: [
                                                              ...
                                                              CustomFormField(title: fields.getField('electric_meter_violation_attachment').label,

                                                                  value: _visitDetail.electricMeterViolationAttachment==null?'':'${appUserProvider.baseUrl}/web/image?model=${Model.visit}&id=${_visitDetail.id}&field=electric_meter_violation_attachment&unique=${_visitDetail.uniqueId}',
                                                                  onChanged:(val) {
                                                                    _visitDetail
                                                                        .electricMeterViolationAttachment =
                                                                        val;
                                                                    setState(() {
                                                          ...
                                                          Column(
                                                            children: [
                                                              ...
                                                              CustomFormField(title: fields.getField('water_meter_violation_attachment').label,

                                                                  value: _visitDetail.waterMeterViolationAttachment==null?'':'${appUserProvider.baseUrl}/web/image?model=${Model.visit}&id=${_visitDetail.id}&field=water_meter_violation_attachment&unique=${_visitDetail.uniqueId}',
                                                                  onChanged:(val) {
                                                                    _visitDetail
                                                                        .waterMeterViolationAttachment =
                                                                        val;
                                                                    setState(() {
                                                          ...
                                                          Column(
                                                            children: [
                                                              CustomFormField(title: getField('mosque_violation_note')!.label,
                                                              ...
                                                              CustomFormField(title: fields.getField('mosque_violation_attachment').label,

                                                                  value: _visitDetail.mosqueViolationAttachment==null?'':'${appUserProvider.baseUrl}/web/image?model=${Model.visit}&id=${_visitDetail.id}&field=mosque_violation_attachment&unique=${_visitDetail.uniqueId}',
                                                                  onChanged:(val) {
                                                                    _visitDetail
                                                                        .mosqueViolationAttachment =
                                                                        val;
                                                                    setState(() {
                                                          ...
                                                          Column(
                                                            children: [
                                                              ...
                                                              CustomFormField(title: fields.getField('binary_holy_quran_violation_attachment').label,

                                                                  value: _visitDetail.holyQuranViolationAttachment==null?'':'${appUserProvider.baseUrl}/web/image?model=${Model.visit}&id=${_visitDetail.id}&field=binary_holy_quran_violation_attachment&unique=${_visitDetail.uniqueId}',
                                                                  onChanged:(val) {
                                                                    _visitDetail
                                                                        .holyQuranViolationAttachment =
                                                                        val;
                                                                    setState(() {
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          _visit.electricMeterViolation=='yes'?
                                                          Column(
                                                            children: [
                                                              AppListTitle2(title: getField('electric_meter_violation_note')!.label,subTitle: _visit.electricMeterViolationNote),
                                                              AppListTitle2(title: fields.getField('electric_meter_violation_attachment').label,
                                                                  subTitle: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=electric_meter_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}'
                                                                    ...
                                                                    Navigator.push(
                                                                      ...
                                                                      MaterialPageRoute(
                                                                        builder: (context) => FullScreenImagePage(
                                                                          title :fields.getField('electric_meter_violation_attachment').label,
                                                                          imageUrl: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=electric_meter_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  }
                                                          ...
                                                          _visit.waterMeterViolation=='yes'?
                                                          Column(
                                                            children: [
                                                              AppListTitle2(title: getField('water_meter_violation_note')!.label,subTitle: _visit.waterMeterViolationNote),
                                                              AppListTitle2(title: fields.getField('water_meter_violation_attachment').label,
                                                                  subTitle: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=water_meter_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}'
                                                                  ,type:ListType.image,headersMap:_headersMap??'',
                                                                  onTab:(){
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                        builder: (context) => FullScreenImagePage(
                                                                          title :fields.getField('water_meter_violation_attachment').label,
                                                                          imageUrl: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=water_meter_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  }
                                                          ...
                                                          _visit.mosqueViolation=='yes' ?
                                                          Column(
                                                            children: [
                                                              AppListTitle2(title: getField('mosque_violation_note')!.label,subTitle: _visit.mosqueViolationNote),
                                                              AppListTitle2(title: fields.getField('mosque_violation_attachment').label,
                                                                  subTitle: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=mosque_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}'
                                                                  ,type:ListType.image,headersMap:_headersMap??'',
                                                                  onTab:(){
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                        builder: (context) => FullScreenImagePage(
                                                                          title :fields.getField('mosque_violation_attachment').label,
                                                                          imageUrl: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=mosque_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  }
                                                          ...
                                                          _visit.holyQuranViolation=='yes'?
                                                          Column(
                                                            children: [
                                                              AppListTitle2(title: getField('holy_quran_violation_note')!.label,subTitle: _visit.holyQuranViolationNote),
                                                              AppListTitle2(title: fields.getField('binary_holy_quran_violation_attachment').label,
                                                                  subTitle: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=binary_holy_quran_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}'
                                                                  ,type:ListType.image,headersMap:_headersMap??'',
                                                                  onTab:(){
                                                                    Navigator.push(
                                                                      context,
                                                                      MaterialPageRoute(
                                                                        builder: (context) => FullScreenImagePage(
                                                                          title :fields.getField('binary_holy_quran_violation_attachment').label,
                                                                          imageUrl: '${appUserProvider.baseUrl}/web/image?model=${Model.visit}&field=binary_holy_quran_violation_attachment&id=${_visit.id}&unique=${_visit.uniqueId}',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  }
                  ...
                  _visit.id==0?Container():(_visit.btnStart!=true
                      && (_visit.observerId==appUserProvider.userProfile.employeeId)
                  )?Row(
                    children: [
                      Expanded(
                        child: Container(
                  ...
                  _visit.isActionButton?Row(
                    children: [
                      ...
                      _visit.displayButtonSetToDraft!?Expanded(
                        child: Container(
                          color: Colors.white,
                          child: SecondaryButton(text: "draft_state".tr(),onTab:(){
                            if(isVerifyDevice()) {
                              setDraftVisit();
                            }
                          }),
              ...
              Row(
                ...
                children: [
                  ...
                  ((_visit!.displayButtonSend??false) && isEditMode==false)?Container(
        ...
        floatingActionButton: (!isEditMode && isVisiablePermission==false && _visit.btnStart==true && _visit.state=='draft'
            && (_visit.observerId==appUserProvider.userProfile.employeeId)
