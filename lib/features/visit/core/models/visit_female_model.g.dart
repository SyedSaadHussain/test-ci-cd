...
part of 'visit_female_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class VisitFemaleModelAdapter extends TypeAdapter<VisitFemaleModel> {
  @override
  final int typeId = 8;

  @override
  VisitFemaleModel read(BinaryReader reader) {
    ...
    return VisitFemaleModel(
      ...
      womenPrayerSignboard: fields[201] as String?,
      cleanFreeBlock: fields[202] as String?,
      doorWorkFine: fields[203] as String?,
      privacyWomenArea: fields[204] as String?,
      womanPrayerAreaSize: fields[205] as String?,
      femaleSectionNotes: fields[206] as String?,
    )
  ...
  @override
  void write(BinaryWriter writer, VisitFemaleModel obj) {
    writer
      ..writeByte(129)
      ..writeByte(201)
      ..write(obj.womenPrayerSignboard)
      ..writeByte(202)
      ..write(obj.cleanFreeBlock)
      ..writeByte(203)
      ..write(obj.doorWorkFine)
      ..writeByte(204)
      ..write(obj.privacyWomenArea)
      ..writeByte(205)
      ..write(obj.womanPrayerAreaSize)
      ..writeByte(206)
      ..write(obj.femaleSectionNotes)
      ..writeByte(0)
      ..write(obj.id)
      ..writeByte(1)
      ..write(obj.latitude)
  ...
  bool operator ==(Object other) =>
      ...
      other is VisitFemaleModelAdapter &&
