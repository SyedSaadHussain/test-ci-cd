...
part of 'regular_visit_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class RegularVisitModelAdapter extends TypeAdapter<RegularVisitModel> {
  @override
  final int typeId = 7;

  @override
  RegularVisitModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, RegularVisitModel obj) {
    writer
      ..writeByte(158)
      ..writeByte(200)
  ...
  bool operator ==(Object other) =>
      ...
      other is RegularVisitModelAdapter &&
