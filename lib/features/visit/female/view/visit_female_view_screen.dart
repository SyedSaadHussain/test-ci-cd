...
import 'package:mosque_management_system/features/visit/core/widget/view/view_women_prayer_section.dart';
...
import 'package:mosque_management_system/core/models/base_state.dart';
 ...
 class VisitFemaleViewScreen extends StatefulWidget {
  final VisitModel visit;
  final Function? onCallback;
  const VisitFemaleViewScreen({super.key, required this.visit,this.onCallback});

  @override
  State<VisitFemaleViewScreen> createState() => _VisitFemaleViewScreenState();
}

 class _VisitFemaleViewScreenState extends BaseState<VisitFemaleViewScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final vm = context.read<VisitViewModel<VisitFemaleModel>>();
  ...
  Widget build(BuildContext context) {
    final vm = context.read<VisitViewModel<VisitFemaleModel>>()  as  VisitFemaleViewViewModel;

    return Scaffold(
      appBar: AppBar(
        title: Text(VisitMessages.femaleVisit),
        actions: [
          VisitActionButton<VisitFemaleModel>()
        ],
      ),
      body: Stack(
        children: [
                        ...
                        Expanded(
                          child:Column(
                            children: [
                              ...
                              Expanded(
                                child: Consumer<VisitViewModel<VisitFemaleModel>>(
                                      ...
                                      return Container(
                                        ...
                                        child: TabBarView(
                                            ...
                                            children:[
                                              ...
                                              ViewWomenPrayerSection(visit: vm.visitObj,fields: vm.fields,),
                                              //meters
          ...
          Selector<VisitViewModel<VisitFemaleModel>, bool>(
