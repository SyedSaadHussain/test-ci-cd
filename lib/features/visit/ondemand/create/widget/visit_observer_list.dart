...
class VisitObserverList extends StatefulWidget {
  final Function onItemTap;
  final String? title;
  final VisitRepository? visitService;
  VisitObserverList({required this.onItemTap,this.title,this.visitService});
  @override
  _VisitObserverListState createState() => _VisitObserverListState();
}

class _VisitObserverListState extends State<VisitObserverList> {
  ...
  void searchRecords(bool isReload){
    ...
    Future.delayed(const Duration(seconds: 0), () {
      widget.visitService!.getOndemandObservers(data.pageIndex,10,_controller.text).then((value){
