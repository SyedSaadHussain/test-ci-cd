...
import 'package:mosque_management_system/core/models/base_state.dart';
 ...
 class VisitOndemandViewScreen extends StatefulWidget {
  final VisitModel visit;
  final Function? onCallback;
  const VisitOndemandViewScreen({super.key, required this.visit,this.onCallback});

  @override
  State<VisitOndemandViewScreen> createState() => _VisitOndemandViewScreenState();
}

 class _VisitOndemandViewScreenState extends BaseState<VisitOndemandViewScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final vm = context.read<VisitViewModel<VisitOndemandModel>>();
  ...
  Widget build(BuildContext context) {
    final vm = context.read<VisitViewModel<VisitOndemandModel>>()  as  VisitOndemandViewViewModel;
    return Scaffold(
      appBar: AppBar(

        title:  Text(VisitMessages.onDemandVisit),
        actions: [
          VisitActionButton<VisitOndemandModel>()
        ],
      ),
      body: Stack(
        children: [
                        ...
                        Expanded(
                          child:Column(
                            children: [
                              ...
                              Expanded(
                                child: Consumer<VisitViewModel<VisitOndemandModel>>(
                                      ...
                                      return Container(
                                        ...
                                        child: TabBarView(
                                            ...
                                            children:[
                                              ...
                                              //mansoob
                                              ViewImamSection(visit: vm.visitObj,fields: vm.fields),
                                              //meters
          ...
          Selector<VisitViewModel<VisitOndemandModel>, bool>(
