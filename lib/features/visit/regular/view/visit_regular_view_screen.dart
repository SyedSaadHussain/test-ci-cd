...
import 'package:mosque_management_system/core/models/base_state.dart';
 ...
 class VisitRegularViewScreen extends StatefulWidget {
  final VisitModel visit;
  const VisitRegularViewScreen({super.key, required this.visit});

  @override
  State<VisitRegularViewScreen> createState() => _VisitRegularViewScreenState();
}

 class _VisitRegularViewScreenState extends BaseState<VisitRegularViewScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    final vm = context.read<VisitViewModel<RegularVisitModel>>();
  ...
  Widget build(BuildContext context) {
    final vm = context.read<VisitViewModel<RegularVisitModel>>()  as  VisitRegularViewViewModel;

    return Scaffold(
      appBar: AppBar(
        title:  Text(VisitMessages.regularVisit),
        actions: [
          VisitActionButton<RegularVisitModel>()
        ],
      ),
      body: Stack(
        children: [
                        ...
                        Expanded(
                          child:Column(
                            children: [
                              ...
                              Expanded(
                                child: Consumer<VisitViewModel<RegularVisitModel>>(
          ...
          Selector<VisitViewModel<RegularVisitModel>, bool>(
