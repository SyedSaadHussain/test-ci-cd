...
class RemoveMosqueFormBody extends StatefulWidget {
  const RemoveMosqueFormBody({super.key});

  @override
  State<RemoveMosqueFormBody> createState() => _RemoveMosqueFormBodyState();
}

class _RemoveMosqueFormBodyState extends State<RemoveMosqueFormBody> {
  // Employee
  String? selectedEmployee;

  // Current Mosque only (no new mosque for removal)
      ...
      child: Column(
        ...
        children: [
          ...
          LabeledInputField(
            ...
            hint: "select_mosque_to_remove".tr(),
            isDropdown: true,
