...
part of 'mosque_local.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MosqueLocalAdapter extends TypeAdapter<MosqueLocal> {
  @override
  final int typeId = 28;

  @override
  MosqueLocal read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MosqueLocal obj) {
    writer
      ..writeByte(125)
      ..writeByte(0)
      ..write(obj.localId)
